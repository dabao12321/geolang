...
def get_catagories():
    '''
    Returns a standard list of regional catagories (states)
    '''
    catagories = []
...
def read_DARE():
    ...
    Outputs:
    examples -- list of translation data by sentence.
    targets -- list of numerical targets (states), corresponding
                    to the index of said state in catagories.
    '''
    geodata = pd.read_csv("../../data/cleaned_dare_corpus.csv")
    examples = []
    targets = []
...
def read_SB_transcriptions():
    ...
    Outputs:
    SBexamples -- list of translation data by sentence.
    SBtargets -- list of numerical targets (states), corresponding
                    to the index of said state in catagories.
    '''
...
def bunch_training(training_data='lexicon'):
    ...
    Output:
    training -- a Bunch containing the training targets, data, and target_names
    '''
